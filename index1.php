...
<html lang="en">
  ...
  <body style="background: #F0F2F0;background: -webkit-linear-gradient(to bottom, #17cec78a, #000);background: linear-gradient(to bottom, #17cec78a, #000); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-heartbeat" aria-hidden="true"></i> GOWELL</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/123.avif" alt="" style="width: 50%;padding-left: 50px;margin-top: 150px;margin-left: 50px;margin-bottom:20px">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> Experience the effortless convenience of our<br> appointment booking system,  designed to </br>eliminate the hassle so you can easily schedule <br>appointments with your favorite doctor.</h4>
          </div>
