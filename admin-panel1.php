...
<html lang="en">
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, #39c8c2, #000);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #39c8c2, #000); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
.list-group-item.active {
    ...
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #39c8c2, #000);
    background: linear-gradient(to right, #39c8c2, #000);
    border-color: #c3c3c3;
}
.text-primary {
    color: #2096bd!important;
}
