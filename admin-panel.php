...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> GOWELL:Healthcare Management System</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-heartbeat" aria-hidden="true"></i> GOWELL</a>
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, ##17cec78a, #000);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #17cec78a, #000); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
...
.list-group-item.active {
    ...
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #2795ba, #000);
    background: linear-gradient(to right, #2795ba, #000);
    border-color: #c3c3c3;
}
.text-primary {
    color: #2795ba!important;
}
