...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-heartbeat" aria-hidden="true"></i>  GOWELL</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://png.pngtree.com/png-vector/20230831/ourmid/pngtree-doctor-doing-research-in-laboratory-3d-character-illustration-png-image_9195695.png" alt="" />
                        <h3>Best Doctors give Least Medicine. <br> "Securely manage patient records, ensuring accurate and accessible information when it's needed most."</h3>
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#medical" role="tab" aria-controls="medical" aria-selected="false">Medical</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="medical" role="tabpanel" aria-labelledby="profile-tab">
    <h3 class="register-heading">Login as Medical</h3>
    <form method="post" action="/SimplePharmacy-PHP/home.php">
        <div class="row register-form">
            <div class="col-md-12">
                <input type="submit" class="btnRegister" name="docsub1" value="Login"/>
            </div>
